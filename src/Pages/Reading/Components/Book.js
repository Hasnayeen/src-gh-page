  ...
  render () {
    return (
      <div className='py-4 border-t' key={this.props.book.id}>
        <a className={(this.props.darkThemeActive ? 'text-grey-lighter' : 'text-grey-darker') + ' no-underline text-xl font-semibold'} href={this.props.book.url} rel='noreferrer noopener' target='_blank'>
